...
export function overwriteConfig(configPath: string, adminPort: number, keystoreConnectionUrl: string, bootstrapServerUrl?: string | undefined | null, signalingServerUrl?: string | undefined | null): string
